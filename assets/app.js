...
(function () {
  ...
  /* Journey strip: you-are-here across the 10 builder sessions */
  var crumb = document.querySelector(".toolbar .crumb");
  var mastheadWrap = document.querySelector(".masthead .wrap");
  if (crumb && mastheadWrap) {
    var m = crumb.textContent.match(/Session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = ["u1-the-pile-with-no-labels.html", "u2-what-similar-means.html",
           "u3-kmeans-from-the-inside.html", "u4-picking-k.html",
           "u5-beyond-kmeans.html", "u6-compressing-the-customer.html",
           "u7-naming-and-shipping-segments.html", "u8-what-sells-together.html",
           "u9-when-clustering-lies.html", "u10-capstone-the-segmentation-project.html"];
